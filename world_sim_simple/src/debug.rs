                ...
                match cmd {
                    ...
                    DebugCommand::ToggleGrid => {
                        ...
                        self.log(
                            DebugLevel::Info,
                            "DEBUG",
                            &format!("Grid display: {}", self.show_grid),
                        );
                    }
                    DebugCommand::ToggleAgents => {
                        ...
                        self.log(
                            DebugLevel::Info,
                            "DEBUG",
                            &format!("Agents display: {}", self.show_agents),
                        );
                    }
                    DebugCommand::ToggleStats => {
                        ...
                        self.log(
                            DebugLevel::Info,
                            "DEBUG",
                            &format!("Stats display: {}", self.show_stats),
                        );
                    }
    ...
    pub fn toggle_category(&self, category: &str) {
        ...
        if enabled.contains(category) {
            ...
            self.log(
                DebugLevel::Info,
                "DEBUG",
                &format!("Disabled category: {}", category),
            );
        } else {
            ...
            self.log(
                DebugLevel::Info,
                "DEBUG",
                &format!("Enabled category: {}", category),
            );
        }
    }
...
fn debug_display_system(debug: Res<DebugSystem>) {
