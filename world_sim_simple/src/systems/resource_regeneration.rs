...
pub fn spawn_regenerating_resources_system(
    ...
    debug.log(
        DebugLevel::Info,
        "RESOURCES",
        &format!("Found {} existing resource nodes, adding berry bushes", existing_count)
    );
    
    // Add more berry bushes around the map
    let berry_positions = vec![
        (30, 30), (35, 30), (40, 30),  // North cluster
        (30, 35), (35, 35), (40, 35),  // Center cluster  
        (30, 40), (35, 40), (40, 40),  // South cluster
        (25, 32), (45, 32),             // East/West singles
        (28, 28), (42, 42),             // Corners
        (32, 25), (32, 45),             // North/South singles
    ];
    ...
    println!("{} Spawned {} regenerating stone deposits",
        "⛰️".white(),
        stone_count
    );
    ...
    debug.log(
        DebugLevel::Info,
        "RESOURCES",
        &format!("Spawned {} berry bushes and {} stone deposits",
...
pub fn add_regeneration_to_trees_system(
    ...
    if count > 0 {
        println!("{} Added regeneration to {} existing trees",
            "🌲".green(),
            count
        );
...
pub fn resource_status_display_system(
    ...
    let depleted = resources.iter()
        .filter(|(r, _, _)| r.amount == 0)
        .count();
    let regenerating = resources.iter()
        .filter(|(r, _, _)| r.amount > 0 && r.amount < r.max_amount)
        .count();
    let full = resources.iter()
    ...
    println!("  Total nodes: {} (Full: {}, Regenerating: {}, Depleted: {})",
    ...
    debug.log(
        DebugLevel::Info,
        "RESOURCES",
        &format!("Resources: {} total, {} full, {} regenerating, {} depleted",
...
pub fn resource_performance_monitor_system(
    ...
    debug.log(
        DebugLevel::Debug,
        "PERFORMANCE",
        &format!("Resources: {} nodes, {}/{} available ({:.0}% utilization)",
